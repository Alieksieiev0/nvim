		...
		config = function()
			require("tokyonight").setup({
				on_highlights = function(hl, colors)
					...
					hl.TelescopePromptTitle = { fg = colors.orange, bg = "none" }
					hl.TelescopePromptNormal = { bg = "none" }
					hl.HarpoonActive = { bg = "none" }
					hl.HarpoonInactive = { fg = colors.dark3, bg = "none" }
					hl.HarpoonNumberActive = { bg = "none" }
					hl.HarpoonNumberInactive = { fg = colors.dark3, bg = "none" }
